...
function header(){
  ...
  var headerAnimation = gsap.timeline({yoyo: false,reversed: true});
      ...
      headerAnimation.from($('.overlay-menu nav li:not(.overlay-menu nav ul li ul li)'), { stagger:.1, y: 30, autoAlpha:0, 'clearProps': 'all', ease: "Expo.easeInOut", }, 0.5);
...
$('.menu-item-has-children > a').each(function(){
  var overlay_animation = gsap.timeline({yoyo: false,reversed: true});
    ...
    $(".back,  .overlay-menu .close").on('click', function() {
